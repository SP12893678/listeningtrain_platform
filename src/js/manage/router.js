...
export default new Router({
    routes: [
        ...
        { path: '/mission-dashboard', name: 'mission-dashboard', component: Mission_dashboard, meta: { permissions: ['admin'] } },
        { path: '/mission-edit', name: 'mission-edit', component: Mission_editpage, props: true, meta: { permissions: ['admin'] } },
